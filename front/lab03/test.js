...
describe('factory Professor', function() {
  let d0;
    ...
    before(async () => {
        d0 = new Professor('1', 'Professor 1', 'professor1@gmail.com', '1111111-1', 'www.image.com/professor1.png');
    })

    it('deve criar professores distintos a cada invocação', function(){
        d0 = new Professor('1', 'Professor 1', 'professor1@gmail.com', '1111111-1', 'www.image.com/professor1.png');
        d1 = new Professor('1', 'Professor 1', 'professor1@gmail.com', '1111111-1', 'www.image.com/professor1.png');
        d2 = new Professor('1', 'Professor 1', 'professor1@gmail.com', '1111111-1', 'www.image.com/professor1.png');
        assert.notEqual(d0, d1);
        assert.notEqual(d0, d2);
        assert.notEqual(d1, d2);
    });
	...
	t0 = new Turma(new Disciplina('ic', 'Introdução a computação', 4, []), '20172')
	d0.aloca_turma(t0);
	assert.deepEqual([t0], d0.turmas_alocadas);
	assert.deepEqual([t0], d0.turmas('20172'));
    });

    it('não deve permitir atualização de matricula via set_matricula', function(){
        assert.throws(function () {
...
describe('factory Estudante', function() {
  let d0;
    ...
    before(async () => {
        d0 = new Estudante('1', 'Estudante 1', 'estudante1@gmail.com', '1111111-1', 'www.image.com/estudante1.png');
    })

    it('deve criar estudantes distintos a cada invocaÃ§Ã£o', function(){
        d0 = new Estudante('1', 'Estudante 1', 'estudante1@gmail.com', '1111111-1', 'www.image.com/estudante1.png');
        d1 = new Estudante('1', 'Estudante 1', 'estudante1@gmail.com', '1111111-1', 'www.image.com/estudante1.png');
        d2 = new Estudante('1', 'Estudante 1', 'estudante1@gmail.com', '1111111-1', 'www.image.com/estudante1.png');
        assert.notEqual(d0, d1);
        assert.notEqual(d0, d2);
        assert.notEqual(d1, d2);
    });
...
describe('factory Turma', function() {
  let d0;
    ...
    before(async () => {
        d0 = new Turma(new Disciplina('ic', 'Introdução a computação', 4, []), '20172');
    })

    it('deve criar turmas distintas a cada invocação', function(){
        d0 = new Turma(new Disciplina('ic', 'Introdução a computação', 4, []), '20172');
        d1 = new Turma(new Disciplina('lprog1', 'Laboratório de programação 1', 4, []), '20172');
        d2 = new Turma(new Disciplina('prog1', 'Programação 1', 4, []), '20172');
        assert.notEqual(d0, d1);
        assert.notEqual(d0, d2);
        assert.notEqual(d1, d2);
    });
    ...
    it('deve reter os dados de inicialização', function(){
        assert.equal('planejada', d0.get_status());
    ...
    it('deve permitir atualizações', function(){
        d0.set_status('asdadasdas');
        assert.equal('planejada', d0.get_status());
        d0.set_status('ativa');
	assert.equal('ativa', d0.get_status());
	assert.deepEqual([], d0.get_estudantes());
	e0 = new Estudante('1', 'Estudante 1', 'estudante1@gmail.com', '1111111-1', 'www.image.com/estudante1.png');
	e1 = new Estudante('2', 'Estudante 2', 'estudante2@gmail.com', '2222222-2', 'www.image.com/estudante2.png')
	d0.matricula(e0);
	d0.matricula(e0);
	...
	assert.deepEqual([e0], d0.get_estudantes());
        d0.desmatricula(e0);
	assert.deepEqual([], d0.get_estudantes());
	p0 = new Professor('1', 'Professor 1', 'professor1@gmail.com', '1111111-1', 'www.image.com/professor1.png');
        assert.equal(null, d0.get_professor());
        d0.set_professor(p0);
